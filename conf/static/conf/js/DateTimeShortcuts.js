...
(function() {
    ...
    var DateTimeShortcuts = {
        ...
        addCalendar: function(inp) {
            ...
            cal_nav_prev.setAttribute('title', 'Cambiar mes');
            ...
            cal_nav_next.setAttribute('title', 'Cambiar mes');
            cal_nav_next.addEventListener('click', function(e) {
                e.preventDefault();
                DateTimeShortcuts.drawNext(num);
            });
            
            // Usado para agregar funcionalidad de cambio de año            
            var cal_nav_prev_year = quickElement('a', cal_nav, '<', 'href', '#');
            cal_nav_prev_year.className = 'calendarnav-previous-year';
            cal_nav_prev_year.setAttribute('title', 'Cambiar año');
            cal_nav_prev_year.addEventListener('click', function(e) {
                e.preventDefault();
                DateTimeShortcuts.drawPrevYear(num);
            });
            
            var cal_nav_next_year = quickElement('a', cal_nav, '>', 'href', '#');
            cal_nav_next_year.className = 'calendarnav-next-year';
            cal_nav_next_year.setAttribute('title', 'Cambiar año');
            cal_nav_next_year.addEventListener('click', function(e) {
                e.preventDefault();
